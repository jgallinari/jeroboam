...
This way, the Clojure API only manipulates pure Clojure data structures like vectors or hash-map as input/ouput, which are then mapped to `java.util.List` or `java.util.Map` in the Java implementation.
